...
function pickRandomNum() {
    computerNum1 = Math.floor(Math.random()*10);
    computerNum2 = Math.floor(Math.random()*10);
    computerNum3 = Math.floor(Math.random()*10);
    console.log(computerNum1)
    console.log(computerNum2)
    console.log(computerNum3)
}
pickRandomNum();    // 함수 실행
...
function play() {
    ...
    // 사용자가 입력한 숫자 가져오기
    // var userNumber = userValue1 + userValue2 + userValue3;
